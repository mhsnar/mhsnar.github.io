...
<table style="width:100%; border:none; border-collapse:collapse;">
  <tr>
    <td style="width:55%; vertical-align:top; border:none; padding-right:20px; text-align: justify;">
      ...
      <br><br>
     My academic journey focuses on developing control theories, implementing them on real robotic systems, and exploring robot interactions with humans. I am particularly interested in leveraging tools from applied analysis and partial differential equations, alongside reinforcement learning, to address challenges in real-world autonomy. I validate these methods through hardware experiments across various robotic platforms, including mobile robots, quadrupeds, and aerial drones. Recently, I have also been working on human–robot interaction problems, with an emphasis on ensuring both safety and efficiency in the robot’s behavior and the interaction itself.
    </td>
...
<table style="width:100%; border:none; border-collapse:collapse;">
  <tr>
    <td style="width:50%; vertical-align:top; border:none; padding-right:20px; text-align: justify;">
      ...
      <br>
       <a href="https://www.youtube.com/embed/i2xlnP974bk?si=5k1qKQ48bUoe4Hcw">[video]</a>
...
model and privileged state information guides a learning agent that observes only a lossy projection of the true state.
    ...
    <td style="width:50%; vertical-align:top; border:none; text-align:center;">
      <img src="images/Your paragraph text (4).gif" alt="Dynamic Embedding Optimization" style="width:100%; border-radius:10px;">
